    ...
    return(
        ...
        style={{display: visibility 
            ...
            <div className="header">
                <h2>Shopping Cart</h2>
                <button className={styles.btn +" "+ styles.closebtn} onClick={onClose}>                     Kryds ikon her
                </button>
            </div>
            <div className={styles.cartproducts}>
                {products.length === 0 && (<span className={styles.emptytext}>
            ...
            {products.length > 0 && <button className={styles.btn + " " +styles.checkoutbt}>
            Proceed to checkout
            </button>}
       </div>
    </div>
